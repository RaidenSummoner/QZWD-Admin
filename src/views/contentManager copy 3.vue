...
<el-row :gutter="10">
  <el-col :span="10">
    ...
    <div style="text-align:left">
      ...
      <el-button type="success" size="small" @click="addRow(kind_consult)">新增</el-button>
    ...
    <div>
      <el-table :data="kind_consult" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" :show-header="false">
          ...
          <el-table-column label="操作" width="300">
            <template slot-scope="scope">
              ...
              <el-button size="small" type="danger" @click="handleDelete(scope.$index, kind_consult)">删除</el-button>
            </template>
          </el-table-column>
      </el-table> 
    </div>
  ...
  <el-col :span="10">
    ...
    <div>
      <el-table :data="kind_course" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" :show-header="false">
          <el-table-column type="selection" width="60">
          </el-table-column>
          <el-table-column prop="name"  label="商品名称" width="120" sortable>
          </el-table-column>
...
//  },
      ...
      confirmEdit(){
        ...
        this.kind_consult[editdata].name=this.Form.name;
        this.kind_consult[editdata].price=this.Form.price;
        this.kind_consult[editdata].reserve=this.Form.reserve;
        this.kind_consult[editdata].data=this.Form.data;
        this.kind_consult[editdata].desc=this.Form.desc;
        this.FormVisible = false;
      ...
      removeUsers() {
          ...
          var ids = [];
          //提取选中项的id
          $.each(this.selected,(i, kind_consult)=> {
          ids.push(kind_consult.id);
          });
          // 向请求服务端删除
